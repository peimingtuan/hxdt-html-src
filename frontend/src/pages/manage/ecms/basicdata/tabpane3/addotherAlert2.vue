                ...
                <div class="main">
                    ...
                    <div class="content">
                        <el-form :label-position="labelPosition" :model="formLabelAlign">
                            <el-form-item class="red-label" label="法庭类型名称">
                                <el-input v-model="formLabelAlign.courtRoomTypeName"></el-input>
                            </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            qure() {
                if(this.formLabelAlign.courtRoomTypeName.replace(/(^\s*)|(\s*$)/g, '')!=='')this.$emit('qure',this.formLabelAlign);
                else this.$msgw('请输入法庭类型名称');
            },
            cancel() {
                this.$emit('cancel');
            },
