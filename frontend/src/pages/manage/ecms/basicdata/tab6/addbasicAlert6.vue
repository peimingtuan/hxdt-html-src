                ...
                <div class="main">
                    ...
                    <div class="content">
                        <el-form :label-position="labelPosition" :model="formLabelAlign">
                            <el-form-item label="视角名称" required>
                                <el-input v-model.trim="formLabelAlign.viewName"></el-input>
                            </el-form-item>
                            <el-form-item label="视角代码" required>
                                <el-input v-model.trim="formLabelAlign.viewCode"></el-input>
                            </el-form-item>
