                ...
                <div class="main">
                    ...
                    <div class="content">
                        <el-form :label-position="labelPosition" :model="formLabelAlign">
                            <el-form-item label="适用程序名称" required>
                                <el-input v-model.trim="formLabelAlign.applyProgramName"></el-input>
                            </el-form-item>
                            <el-form-item label="适用程序代码" required>
                                <el-input v-model.trim="formLabelAlign.applyProgramCode"></el-input>
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="bt">
    ...
    export default {
        ...
        data() {
            return {
                ...
                formLabelAlign: {
                    applyProgramCode:'',//适用程序代码
                    applyProgramName:'',//适用程序名称
                    applyProgramId:''//适用程序Id,
                },
            }
        },
        created() {
