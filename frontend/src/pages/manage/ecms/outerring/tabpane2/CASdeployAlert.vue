<template>
  <div class="CASdeployAlert">
    <!--弹框-->
    <transition name="slide-fade">
      <div class="second-alert" v-show="isMain3">
        <div class="main2">
          ...
          <div class="content">
            <el-form ref="form" :label-position="labelPosition" :model="formLabelAlign">
              <el-form-item label="显示内容" prop="openSelect">
                <!-- <el-checkbox v-model="waitChecked"  @change="hanlderChange">等待开庭</el-checkbox>
                <span>{{}}</span>(显示顺序)
                <el-checkbox v-model="openChecked"  @change="hanlderChange">开庭</el-checkbox>
                <el-checkbox v-model="finishChecked"  @change="hanlderChange">闭庭</el-checkbox>
                <el-checkbox v-model="sleepChecked"  @change="hanlderChange">休庭</el-checkbox>-->
    ...
    submitForm() {
      ...
      _this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          _this.$http
            .post("/casconfig/updateTemplateConfig", {
