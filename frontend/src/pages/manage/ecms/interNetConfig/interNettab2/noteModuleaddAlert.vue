<template>
    <div class="noteModuleaddAlert">
        ...
        <div class="title">示例:<span>您参与的"${案号}"案件于${开庭日期}${开庭时间}开庭，请马上登录互联网庭审客户端，并立即参加在线庭审。</span></div>
        <div class="remark">
    ...
    export default {
        ...
        data() {
            return {
                ...
                formLabelAlign: {
                    ...
                    smsBussinessType:'INTERNET_SMS_BUSSINESS_TYPE',
                },
                returnLabelList:Array(10).fill({templateVariableName:'法庭'})
            }
        },
        created() {
        },
        ...
        methods: {
            ...
            async getMessageTemplateVariables(){
                let res=await this.$http.post('/messageTemplateVariableConfig/getMessageTemplateVariables',{templateVariableType:'INTERNET_SMS_BUSSINESS_TYPE'},true)
