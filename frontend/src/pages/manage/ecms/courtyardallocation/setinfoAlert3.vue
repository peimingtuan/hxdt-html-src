                        ...
                        <div class="content-info2-div1">
                            <el-form :label-position="labelPosition" :model="formLabelAlign">
                                <el-form-item label="字幕内容设置">
                                    ...
                                    <el-checkbox v-model="formLabelAlign.pushTime">系统时间</el-checkbox>
                                </el-form-item>
                                <el-form-item label="自定义字幕">
                                    <el-input type="textarea" v-model="formLabelAlign.subtitleContent" placeholder="......"></el-input>
                                </el-form-item>
                                字幕样式设置:<br/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                locationlist:[{id:'NONE',name:'不显示'},{id:'UPPER_LEFT',name:'左上'},{id:'LOWER_LEFT',name:'左下'},{id:'UPPER_RIGHT',name:'右上'},{id:'LOWER_RIGHT',name:'右下'}],//字幕,系统显示位置select
                colorlist:[{id:'WHITE',name:'白色'},{id:'BLACK',name:'黑色'},{id:'RED',name:'红色'},{id:'BLUE',name:'蓝色'},{id:'YELLOW',name:'黄色'},{id:'GREEN',name:'绿色'}],//字幕,系统显示位置select
                setlawname:false,
                setcase:false,
                setdraw:false,
                formLabelAlign: {//表单信息
        ...
        methods: {
            ...
            show(row){
                ...
                if(row){
                    ...
                    let arr=row.captionsSource.split('');
                    arr.map((item,index)=>{
                        if(index==0){
                            if(item==1)this.setlawname=true;
                            else this.setlawname=false;
                        }else if(index==1){
                            if(item==1)this.setcase=true;
                            else this.setcase=false;
                        }else if(index==2){
                            if(item==1)this.setdraw=true;
                            else this.setdraw=false;
                        }
                    })
                }else{
