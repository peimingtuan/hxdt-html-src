                    ...
                    <div class="content-info2">
                        <div class="content-info2-div1">
                            <el-form :label-position="labelPosition" :model="formLabelAlign">
                                ...
                                <el-form-item class="red-label" label="序列号">
                                    <el-input type="text" v-model.trim="formLabelAlign.courtDeviceSerialNumber"></el-input>
                                </el-form-item>
    ...
    export default {
        ...
        data() {
            return {
                ...
                courtDeviceTypelist:[{courtDeviceType:1,name:'编码器'},{courtDeviceType:2,name:'解码器'},{courtDeviceType:3,name:'编解码器'}],//设备类型select
                //courtDeviceModellist:[{courtDeviceModel:1,courtDeviceModelName:'编码器'},{courtDeviceModel:2,courtDeviceModelName:'解码器'},{courtDeviceModel:3,courtDeviceModelName:'编解码器'}],//设备型号select
                ...
                formLabelAlign: {//表单信息
                    ...
                    courtDeviceModel:3,//设备型号代码
                    courtDeviceModelName:'DVC3010',//设备型号名称
        ...
        methods: {
            ...
            getdata(){
                ...
                _this.$showToast('加载中...')
                _this.$http.post('/courtRoomConfig/getDeviceInfo',{
                    ...
                    if(data.code===200){
                        ...
                        formLabelAlign.courtDeviceSerialNumber=data.data.courtDeviceSerialNumber;
                    }else{
            ...
            getCourtDeviceModelInfo(){
                let _this=this;
                _this.$showToast( '加载中...')
                return _this.$http.post('/getCourtDeviceModelInfo',{}).then(data =>{
                    _this.$hideToast()
                    if(data.code===200){
           ...
           async show(row){
                ...
                if(this.courtDeviceModellist.length===0){
                    await this.getCourtDeviceModelInfo();
                }
                if(row){
            ...
            sureedit(){
                ...
                if(!Tool.isValidIP(formLabelAlign.courtDeviceIp)){
                    this.$msgw("请输入有效IP");
                    return
                }
                if(!formLabelAlign.courtDeviceSerialNumber){
                    this.$msgw('请输入序列号');
                    return
                }
                let _this=this;
                ...
                _this.$showToast('加载中...')
                _this.$http.post('/courtRoomConfig/saveOrUpdateCourtRoomDeviceInfo',formLabelAlign).then(data =>{
                    _this.$hideToast()
                    if(data.code===200){
                    ...
                    _this.$hideToast()
                    console.log(err,'/courtRoomConfig/saveOrUpdateCourtRoomDeviceInfo')
                    _this.$msge('服务器异常，请稍后重试');
                })
            }
        }
