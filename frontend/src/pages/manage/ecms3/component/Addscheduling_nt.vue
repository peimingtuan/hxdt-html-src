<template>
    <!-- 排期管理下的修改排期 -->
        <div class="Addscheduling_Nt">
            <!--远程庭审室选择-->
            <courtyardChoice ref="courtyardChoice"></courtyardChoice>
                <!--弹框-->
        <transition name="slide-fade">
            <div class='second-alert' v-if='isAddscheduling_nt'>
                        ...
                        <div class="content" id="content">
                                <el-form :label-position="labelPosition" :model="formLabelAlign">
                                        <el-form-item label="庭次">
                                            <el-input v-model="formLabelAlign.courtTime" placeholder="庭次"> </el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item label="法庭">
                                                <el-select v-model="formLabelAlign.courtRoomName" placeholder="请选择">
                                                        <el-option v-for="item in pop_ftlist"  :key="item.courtRoomId" :label="item.courtRoomName" :value="item.courtRoomName">
                                                        </el-option>
                                                </el-select>
                                        </el-form-item>
                                ...
                                <div class="label-k" >
                                    <el-form :label-position="labelPosition" :model="formLabelAlign">
                                        ...
                                        <el-form-item label="人民审判员(可多选)" v-show="!formLabelAlign.soleTrial">
                                            <el-select v-model="value3" filterable multiple>
                                                <el-option v-for="item in userList"
                                                           :key="item.userId"
                                                           :label="item.userName"
                                                           :value="item.userId">
                                ...
                                <el-form :label-position="labelPosition" :model="formLabelAlign">
                                    ...
                                    <div class="zkt-left">
                                        ...
                                        <div v-for="(item,index) in reomtelist" :key="index">
                                            远{{index+1}}：
                                            <div class="case-yo">
                                                <el-input v-model="item.name"></el-input>
                                                <span class="span-btn" @click="openCourtyard(item.name)">...</span>
                                            </div>
                                            <img v-show="index>0" @click="removeRoom" src="../images/CaseManagement/yuancheng/del.png" />
                                        </div>
                                    </div>
                                </el-form>
                        </div>
    ...
    <script>
        // import {basedata} from "../CaseInformation/baseData.js"//引入数据
        import $ from "jquery"
        ...
        export default {
            ...
            data() {
                return {
                    ...
                    formLabelAlign:{
                        ...
                        trialMemberList:[
                            // {
                            //     trialMemberName: "",//取下拉选userName
                            //     trialMemberTypeCode:'',//1审判长2审判员 3执行员 4人民陪审员 5 法官助理 6书记员 7司法警察 8 技术调查者 255 其他
                            //     userId: ""//取下拉选userId
                            // }
                        ],//审判组织成员
            ...
            mounted() {
                if(this.pop_ftlist.length===0){
                    this.getTrialModeInfos();
                    this.getTrialFormInfos();
                    this.getCourtWayInfos();
                }
            },
            destroyed() {
