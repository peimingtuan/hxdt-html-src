<template>
    ...
    <script>
        import $ from "jquery"
        import {CaseInformation,AllInfoByCaseInfoIdList} from "../js/datajson"
        ...
        export default {
            ...
            methods: {
                ...
                getcheck1(data){
                 ...
                 getcheck2(data){
                    //console.log(data,e)
                    this.$refs.check2.getAllInfoByCaseInfoId(data);//案件下所有信息请求
                },
                 //中转站
                 getcheck3(data){
                    //console.log(data,e)
                    this.$refs.check3.getAllInfoByCaseInfoId(data);//案件下所有信息请求
                },
                //注册弹框显示与否事件
                showAlert() {
