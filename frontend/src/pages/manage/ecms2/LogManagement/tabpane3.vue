    ...
    <div class="tabplane3">
            <el-row class='onerow'>
                    <el-col :span='24'>
                            <div class="add">
                                    ...
                                    <img src="../images/CaseManagement/导入.png" alt=""  @click="handleEdit(scope.row)">
                            ...
                            <!-- <div class="isedit">
                                    ...
                                    <el-button type="text" @click="handleEdit(scope.$index, scope.row)">导出</el-button>
            ...
            <el-row class='tworowu'>
                    <div  class="date-d">
                            ...
                            用户<el-input style='width:3rem' clearable></el-input>
            ...
            <el-row class='threerowu'>
                    <div class='casetable'>
                            ...
                            <el-table-column prop="moduleId"label="用户"show-overflow-tooltip></el-table-column>
                            ...
                            <el-table-column prop="recordDate"label="日期"show-overflow-tooltip></el-table-column>
                            <el-table-column prop="recordTime"label="时间" show-overflow-tooltip></el-table-column>
