...
const CaseInformation={
    yearlist:[{id: 1, name: "全部"}, {id: 2, name: new Date().getFullYear()+3},{id: 3, name: new Date().getFullYear()+2},{id:4, name: new Date().getFullYear()+1},{id: 5, name: new Date().getFullYear()}, {id: 6, name: new Date().getFullYear()-1}, {id: 7, name: new Date().getFullYear()-2}],//年份
